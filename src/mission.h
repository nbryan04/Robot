...
public:
    ...
    enum State {
        ...
        PANEL_REMOVE,     // removal sequence at the panel: turn -> drive -> turn
...
private:
    ...
    // Panel removal sequence (runs after PANEL_ALIGN lands on the IR spot):
    // lower claw -> pre-drive -> turn1 -> drive straight -> turn2. Angles:
    // + = right/CW, - = left/CCW.
