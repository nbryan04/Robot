...
Motor motor1(PWM_PIN1_M1, PWM_PIN2_M1, ENCODER_PIN1_M1,
             robotConfig::WHEEL_1_DIAMETER, robotConfig::MOTOR1_POLARITY);
Motor motor2(PWM_PIN1_M2, PWM_PIN2_M2, ENCODER_PIN1_M2,
             robotConfig::WHEEL_1_DIAMETER, robotConfig::MOTOR2_POLARITY);
void setup() {
    motor1.begin();
    motor2.begin();
    Serial.begin(115200);
